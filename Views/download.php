...
<div class="food">
    <div class="container">
        ...
        <div class="row" style="justify-content: center">
            <div class="col-md-4">
                <div class="food_box">
                    <i><img src="../Static/images/php-svgrepo-com%20(1).svg" alt="product"/></i>
                    ...
                    <section class="download-links">
                        ...
                        <a style="width:120px; height:40px; color:#FFF;" class="btn btn-dark btn-download"
                           target="_blank" href="<?php echo $productService->getObjectDownloadLink() ?>" download="
            <?php $products->current()['Key'] ?>">
                            S3
                        </a>
